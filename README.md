...
- **[Program-aided prompting](prompting/program-aided.md)** ![paper](assets/badges/paper.svg)<!-- [paper] --> — Generate executable reasoning steps, then let an interpreter handle exact computation.
