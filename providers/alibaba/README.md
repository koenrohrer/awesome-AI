...
|---|---|---|
| Qwen3 series | General model family | Instruct + base variants, open weights on HuggingFace |
...
- **Broad specialist lineup.** Dedicated code (Qwen-Coder), math (Qwen-Math), vision (Qwen-VL), and audio (Qwen-Audio) variants. Useful when a task maps to a specialist model family.
