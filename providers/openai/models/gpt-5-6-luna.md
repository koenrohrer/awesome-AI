...
OpenAI cut the Luna price by 80 percent on July 30, 2026, so the current model page lists lower prices than the July 9 launch announcement. Verify the live page when estimating cost. [Changelog](https://developers.openai.com/api/docs/changelog).
