...
| Model line | Repo coverage | Evidence |
|---|---|---|
| [GPT-5.5](../openai/models/gpt-5-5.md) | Full page; product-only/API soon | `[provider-doc]` [Introducing GPT-5.5](https://openai.com/index/introducing-gpt-5-5/), [GPT-5.5 system card](https://openai.com/index/gpt-5-5-system-card/) |
| [GPT-5.5 Pro](../openai/models/gpt-5-5-pro.md) | Full page; product-only/API soon | `[provider-doc]` [Introducing GPT-5.5](https://openai.com/index/introducing-gpt-5-5/), [GPT-5.5 system card](https://openai.com/index/gpt-5-5-system-card/) |
...
| [GPT-5.3 Instant](../openai/models/gpt-5-3-instant.md) | Full page | `[provider-doc]` [OpenAI models](https://developers.openai.com/api/docs/models) |
...
| [GPT-5-Codex](../openai/models/gpt-5-codex.md) | Full page | `[provider-doc]` [OpenAI models](https://developers.openai.com/api/docs/models) |
| [codex-mini-latest](../openai/models/codex-mini-latest.md) | Full page | `[provider-doc]` [OpenAI models](https://developers.openai.com/api/docs/models) |
| GPT Image 2, `gpt-realtime-1.5`, transcription, embeddings, moderation | Docs only | `[provider-doc]` [OpenAI models](https://developers.openai.com/api/docs/models) |
...
| Gemini 3.1 Flash-Lite Preview | Docs only | `[provider-doc]` [Gemini models](https://ai.google.dev/gemini-api/docs/models) |
...
| Nano Banana 2, Gemini 3.1 Flash Live, Gemini 3.1 Flash TTS | Docs only | `[provider-doc]` [Gemini models](https://ai.google.dev/gemini-api/docs/models) |
...
| Veo 3.1, Veo 3.1 Lite, Imagen 4, Lyria 3, Lyria RealTime | Docs only | `[provider-doc]` [Gemini models](https://ai.google.dev/gemini-api/docs/models) |
...
| [Kimi K2.5](../moonshot/models/kimi-k2-5.md) | Full page | `[provider-doc]` [Kimi API docs](https://platform.kimi.ai/docs/overview) |
| [Kimi K2 Thinking](../moonshot/models/kimi-k2-thinking.md) | Full page | `[provider-doc]` [Kimi API docs](https://platform.kimi.ai/docs/overview) |
| `kimi-k2`, `kimi-k2-turbo-preview`, `kimi-k2-thinking-turbo` | Docs only | `[provider-doc]` [Kimi API docs](https://platform.kimi.ai/docs/overview) |

## MiniMax

| Model line | Repo coverage | Evidence |
|---|---|---|
| [MiniMax M2.7](../minimax/models/minimax-m2-7.md) | Full page | `[provider-doc]` [MiniMax API overview](https://platform.minimaxi.com/docs/api-reference/api-overview) |
| MiniMax M2.7-highspeed | Docs only | `[provider-doc]` [MiniMax API overview](https://platform.minimaxi.com/docs/api-reference/api-overview) |
| [MiniMax M2.5](../minimax/models/minimax-m2-5.md) | Full page | `[provider-doc]` [MiniMax API overview](https://platform.minimaxi.com/docs/api-reference/api-overview) |
| [MiniMax M2.5-highspeed](../minimax/models/minimax-m2-5-highspeed.md) | Full page | `[provider-doc]` [MiniMax API overview](https://platform.minimaxi.com/docs/api-reference/api-overview) |
| [MiniMax M2.1](../minimax/models/minimax-m2-1.md) | Full page | `[provider-doc]` [MiniMax API overview](https://platform.minimaxi.com/docs/api-reference/api-overview) |
| MiniMax M2.1-highspeed, MiniMax M2 | Docs only | `[provider-doc]` [MiniMax API overview](https://platform.minimaxi.com/docs/api-reference/api-overview) |
...
| MiniMax speech, Hailuo video, image, music models | Docs only | `[provider-doc]` [MiniMax API overview](https://platform.minimaxi.com/docs/api-reference/api-overview) |

## Other seeded providers

| Provider | Repo coverage | Evidence |
|---|---|---|
| [xAI Grok models](../xai/) | Full pages for Grok 4.20, Grok 4 Fast, and Grok Code Fast 1 | `[provider-doc]` [xAI models](https://docs.x.ai/developers/models) |
| [Meta Llama models](../meta/) | Full pages for Llama 4 and guard models | `[provider-doc]` [Meta Llama docs](https://www.llama.com/docs/) |
| [Alibaba Qwen models](../alibaba/) | Provider overview seeded; individual model pages pending | `[provider-doc]` [Qwen](https://qwen.ai/), [Qwen on Hugging Face](https://huggingface.co/Qwen) |
| [Mistral models](../mistral/) | Provider overview seeded; individual model pages pending | `[provider-doc]` [Mistral docs](https://docs.mistral.ai/), [Mistral news](https://mistral.ai/news/) |
