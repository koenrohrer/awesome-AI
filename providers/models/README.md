...
| MiniMax speech, Hailuo video, image, music models | Docs only | `[provider-doc]` [MiniMax API overview](https://platform.minimax.io/docs/api-reference/api-overview) |
...
| Mistral OCR 4 | Docs only; hosted document service | `[provider-doc]` [Model card](https://docs.mistral.ai/models/model-cards/ocr-4-0) |
