...
- **[Architecture explainers](architecture/)** — RAG, KV cache, MTP/speculative decoding, MoE, fine-tuning/LoRA, tokenization, quantization. Links to the best source-backed primer for each, not yet-another-blog-post.
