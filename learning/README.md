...
- **[Architecture explainers](architecture/)** — RAG, KV cache, MTP/speculative decoding, MoE, fine-tuning/LoRA, tokenization, and quantization, with source-backed primers.
