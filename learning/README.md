...
- **[Architecture explainers](architecture/)** — RAG, KV cache, MTP/speculative decoding, sparse attention, MoE, fine-tuning/LoRA, tokenization, and quantization, with source-backed primers.
